                                ...
                                @csrf
                                    <div class="form-group">
                                        <label for="artist_name">Nama Artis</label>
                                            ...
                                            <option value="{{$album->artist->artist_id}}" selected>{{$album->artist->artist_name}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('album_name') is-invalid @enderror" value="{{old('album_name', $album->album_name)}}" type="text" name="album_name">
                                        @error('album_name')
